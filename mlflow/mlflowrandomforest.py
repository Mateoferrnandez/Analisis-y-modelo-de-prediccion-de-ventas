...
params = {
    ...
    "min_samples_leaf": 1,  # Número mínimo de muestras en un nodo hoja. Por defecto es 1.
    ...
    "warm_start": False,  # Si se reutilizan los árboles previos para agregar más árboles. Por defecto es False.
